...
class AppStyles {
  ...
  static final bold16 = _createStyle(fontSize: 16, fontWeight: FontWeight.w700);
  static final bold20 = _createStyle(fontSize: 20, fontWeight: FontWeight.w700);
  static final bold24 = _createStyle(fontSize: 24, fontWeight: FontWeight.w700);
  static final bold14 = _createStyle(fontSize: 14, fontWeight: FontWeight.w700);

  static final bold12 = _createStyle(fontSize: 12, fontWeight: FontWeight.w700);
  static final bold10 = _createStyle(fontSize: 10, fontWeight: FontWeight.w700);
  static final bold8 = _createStyle(fontSize: 8, fontWeight: FontWeight.w700);
  ...
  static final medium8 = _createStyle(fontSize: 8, fontWeight: FontWeight.w500);
